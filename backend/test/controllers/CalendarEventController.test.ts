...
describe('CalendarEventController', () => {
  ...
  */
    ...
    it('Returns a single calendar event', async () => {
        ...
        Object.keys(calendarEvent).length.should.equal(Object.keys(body.payload!).length);
    ...
    it('Returns a single calendar event as iCal', async () => {
        ...
        const calendarEventString = await createICal(calendarEvent, mockDate, mockDate);
