        ...
        it('Returns sessions (old and ongoing) by a single user', done => {
            chai.request(app)
                ...
                .end((err, res: ChaiHttp.Response) => {
                    ...
                    body.payload![0].userId.should.equal(1);
                    body.payload![0].startMessage.should.equal("Let's get this party started.");
                ...
                .end((err, res: ChaiHttp.Response) => {
                    ...
                    chai.request(app)
                        ...
                        .end((err2: any, res2: ChaiHttp.Response) => {
                            ...
                            body2.message!.should.equal("Session ended with message 'Good night all!'");
                            done();
                        });
                });
        });
        ...
        it('User can not start a session if he/she already has an ongoing session.', done => {
            chai.request(app)
                ...
                .end((err, res: ChaiHttp.Response) => {
                    ...
                    should.exist(body.error);
                    should.exist(body.error!.message);
                    body.error!.message.should.equal('You already have an ongoing session running.');
                    done();
                });
        });
        ...
        it("User can not stop a session if he/she doesn't have an ongoing session.", done => {
            chai.request(app)
                ...
                .end((err, res: ChaiHttp.Response) => {
                    ...
                    should.exist(body.error);
                    should.exist(body.error!.message);
                    body.error!.message.should.equal("You don't have an ongoing session.");
                    done();
                });
        });
