...
// Users route
app.use(apiUrl('users', API_VERSION), apiHeader(API_VERSION), UserController.routes());

// Auth route
app.use(apiUrl('authenticate', API_VERSION), AuthController.routes());

// Student unions route
app.use(apiUrl('studentunion', API_VERSION), apiHeader(API_VERSION), StudentUnionController.routes());

// Calendar route
app.use(apiUrl('calendar', API_VERSION), apiHeader(API_VERSION), CalendarEventController.routes());

// Location route
app.use(apiUrl('location', API_VERSION), apiHeader(API_VERSION), LocationController.routes());

// Permission route
app.use(apiUrl('permission', API_VERSION), apiHeader(API_VERSION), PermissionController.routes());

// Watch route
app.use(apiUrl('session', API_VERSION), apiHeader(API_VERSION), SessionController.routes());

// Message route
app.use(apiUrl('message', API_VERSION), apiHeader(API_VERSION), MessageController.routes());

// Newspost route
app.use(apiUrl('newspost', API_VERSION), apiHeader(API_VERSION), NewsPostController.routes());
...
// Keys route
app.use(apiUrl('key', API_VERSION), apiHeader(API_VERSION), KeyController.routes());
