...
export const toggleSessionPage = (value: boolean) => action(TOGGLE_SESSION_PAGE, { value });

export const toggleIsEnding = (value: boolean) => action(TOGGLE_IS_ENDING, { value });

export const toggleIsStarting = (value: boolean) => action(TOGGLE_IS_STARTING, { value });

export const toggleStartSessionModal = (value: boolean) => action(TOGGLE_START_SESSION_MODAL, { value });

export const toggleEndSessionModal = (value: boolean) => action(TOGGLE_END_SESSION_MODAL, { value });

export const setSessionCheckInterval = (interval: NodeJS.Timeout) => action(SET_SESSION_CHECK_INTERVAL, { interval });
