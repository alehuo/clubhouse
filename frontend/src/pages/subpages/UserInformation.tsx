    ...
    return (
        <React.Fragment>
            ...
            <p>
                ...
                <strong>
                    Please note that account deletion is permanent and you have to create a new account in case you want
            ...
            <p>You can download your personal information that is stored on the server about you.</p>
            <p>You will be prompted with a zip-file that includes all of your personal information.</p>
            <ul>
                <li>
                    <b>First name</b>, <b>Last name</b>, <b>Email-address</b>, <b>Account registration date</b> and{' '}
                    <b>Account update date</b>
                </li>
                <li>
