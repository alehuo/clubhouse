...
const NewsPage: React.FC<Props> = ({
    ...
    return (
        <React.Fragment>
                ...
                newsPosts.map(newsPost => (
                    <NewsPost
                        ...
                        onDelete={event => {
                            ...
                            if (window.confirm('Do you want to delete the selected newspost?')) {
            ...
            <AddNewspost show={addModalOpen} onHide={() => toggleNewsAddModal(false)} />
            <EditNewspost show={editModalOpen} onHide={() => toggleNewsEditModal(false)} />
            {editDeletePermissions && (
                <Fab color="primary" className={classes.fab} onClick={() => toggleNewsAddModal(true)}>
                    <AddIcon />
                </Fab>
            )}
        </React.Fragment>
